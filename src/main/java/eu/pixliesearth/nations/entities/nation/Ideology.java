...
public enum Ideology {
    ...
    COMMUNISM('4', Material.IRON_PICKAXE, "§a§oGains the political power someone ", "§a§oelse spends from justifying on them"),
    ...
    LIBERAL_DEMOCRACY('e', Material.TORCH, "§a§o+0.05 Political power", "§a§o per every allied nation"),
    ABSOLUTE_MONARCHY('6', Material.GOLDEN_HELMET),
    FASCISM('3', Material.WITHER_ROSE, "§a§o2x Faster Justification"),
    THEOCRACY('2', Material.BOOK, "§a§o15% Cheaper Justification on people", "§a§o who are a different religion"),
