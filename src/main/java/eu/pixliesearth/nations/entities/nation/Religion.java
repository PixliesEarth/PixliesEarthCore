...
public enum Religion {
    ...
    BUDHISM('6', Material.BROWN_STAINED_GLASS_PANE),
    HINDUISM('e', Material.YELLOW_STAINED_GLASS_PANE),
    CATHOLISM('9', Material.BLUE_STAINED_GLASS_PANE),
    ...
    JEWISH('3', Material.LIGHT_BLUE_STAINED_GLASS_PANE),
    ATHEIST('f', Material.WHITE_STAINED_GLASS_PANE),
    ;
