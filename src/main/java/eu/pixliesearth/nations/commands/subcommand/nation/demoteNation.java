...
public class demoteNation extends SubCommand {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        for (int i = (int) targetProfile.getCurrentNationRank().getPriority(); i >= 0; i--) {
            ...
            if (rank != null) {
                ...
                if (MiniMick.getConfigs().containsKey(nation.getNationId())) {
                    try {
                        ...
                        channel.sendMessage(
                                new EmbedBuilder()
                                        .setTitle(target.getName() + " was demoted to " + rank.getName() + " in your nation.")
