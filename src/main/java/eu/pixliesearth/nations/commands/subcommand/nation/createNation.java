...
public class createNation implements SubCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        Nation nation = new Nation(id, name, "No description :(", Era.TRIBAL.getName(), Ideology.NON_ALIGNED.name(), Religion.ATHEIST.name(), 0, 0.0, player.getUniqueId().toString(), "#34ebc3", "#33968b", System.currentTimeMillis()+"", new HashMap<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList(), new ArrayList<>(), new ArrayList<>(), new HashMap<>(), new HashMap<>());
