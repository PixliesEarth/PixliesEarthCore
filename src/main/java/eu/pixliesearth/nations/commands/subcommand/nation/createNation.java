...
public class createNation implements SubCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        Nation nation = new Nation(Methods.generateId(7), name, "No description :(", Era.START.getName(), Ideology.DEMOCRACY.name(), Religion.ATHEIST.name(),0,0.0, player.getUniqueId().toString(), new ArrayList<>(), new ArrayList<>());
        nation.save();
