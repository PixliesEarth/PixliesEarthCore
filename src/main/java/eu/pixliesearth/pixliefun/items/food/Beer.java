...
public class Beer extends SimpleSlimefunItem<ItemConsumptionHandler> {

    public Beer() {
        super(PixlieFun.foodAndDrinks, PixlieFunItems.BEER, PixlieFun.DISTILLERY, new ItemStack[] {new ItemStack(Material.WHEAT), new ItemStack(Material.WHEAT_SEEDS, 2), new ItemStack(Material.GLASS_BOTTLE), null, null, null, null, null, null});
    }
