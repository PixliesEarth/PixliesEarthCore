...
public class Machine {
    ...
    public enum MachineCraftable {
        ...
        DAMASCUS_STEEL_INGOT25(MachineType.FORGE, CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot25"), Arrays.asList(CustomItemUtil.getItemStackFromUUID("Pixlies:Steel_Ingot"), new ItemStack(IRON_INGOT)), Collections.singletonList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot25")), 8, Era.MEDIEVAL),
        DAMASCUS_STEEL_INGOT50(MachineType.FORGE, CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot50"), Arrays.asList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot25"), new ItemStack(IRON_INGOT, 2)), Collections.singletonList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot50")), 8, Era.MEDIEVAL),
        DAMASCUS_STEEL_INGOT75(MachineType.FORGE, CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot75"), Arrays.asList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot50"), new ItemStack(IRON_INGOT, 3)), Collections.singletonList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot75")), 8, Era.MEDIEVAL),
        DAMASCUS_STEEL_INGOT(MachineType.FORGE, CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot"), Arrays.asList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot75"), new ItemStack(IRON_INGOT, 4)), Collections.singletonList(CustomItemUtil.getItemStackFromUUID("Pixlies:Damascus_Steel_Ingot")), 8, Era.MEDIEVAL),
