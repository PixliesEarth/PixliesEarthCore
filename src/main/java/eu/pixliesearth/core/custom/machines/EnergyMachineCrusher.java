	...
	public void onTick(Location loc, Inventory inv, Timer timer) {
		...
		if (timer==null) {
			...
			if (id==null) {
				...
				addToResult(loc, inv, table[new Random().nextInt(table.length)]);
			} else if(id.equalsIgnoreCase(MinecraftMaterial.SPRUCE_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.OAK_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.JUNGLE_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.DARK_OAK_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.BIRCH_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.ACACIA_SAPLING.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.CACTUS.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.ROTTEN_FLESH.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.WHEAT.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.POTATO.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.CARROT.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.PUMPKIN.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.PUMPKIN_PIE.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.BREAD.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.MELON.getUUID()) || id.equalsIgnoreCase(MinecraftMaterial.MELON_SLICE.getUUID())) {
				ItemStack[] table = {
