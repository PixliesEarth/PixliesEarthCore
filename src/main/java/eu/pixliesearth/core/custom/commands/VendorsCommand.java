...
public class VendorsCommand extends CustomCommand {
    ...
    public boolean execute(CommandSender commandsender, String alias, String[] args) {
        ...
        Main.getInstance().getVendorItems().put(CustomItemUtil.getUUIDFromItemStack(((Player)commandsender).getInventory().getItemInMainHand()), new VendorItem(Machine.serialize(((Player)commandsender).getInventory().getItemInMainHand()), buy, sell));
