...
public class SetSpectatorSubCommand extends CustomSubCommand {
    ...
    public String getCommandUsage() {
        return "Set the spectator spawn for the gulag.";
    }
    ...
    public boolean onExecuted(CommandSender commandSender, String aliasUsed, String[] parameters, boolean ranByPlayer) {
        ...
        gulag.setSpectatorLocation(Methods.locationToSaveableString(player.getLocation()));
        instance.setGulag(gulag);
        instance.getConfig().set("gulag", instance.getGson().toJson(gulag));
        instance.saveConfig();
        player.sendMessage("§7Changed the spectator spawn.");
        return true;
    }
