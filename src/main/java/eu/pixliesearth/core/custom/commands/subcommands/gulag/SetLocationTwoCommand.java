...
public class SetLocationTwoCommand extends CustomSubCommand {

    @Override
    public String getCommandName() {
        return "setlocationtwo";
    }

    @Override
    public String getCommandUsage() {
        return "Set the second spawn for the gulag.";
    }
    ...
    public boolean onExecuted(CommandSender commandSender, String aliasUsed, String[] parameters, boolean ranByPlayer) {
        ...
        gulag.setFighterTwo(Methods.locationToSaveableString(player.getLocation()));
        instance.setGulag(gulag);
        instance.getConfig().set("gulag", instance.getGson().toJson(gulag));
        instance.saveConfig();
        player.sendMessage("§7Changed the second spawn.");
        return true;
    }
