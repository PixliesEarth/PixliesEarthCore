...
public class EnergyBlockBatBox extends CustomEnergyBlock implements IHopperable {
	
	public EnergyBlockBatBox() {
	...
	public void onTick(Location location, Inventory inventory, Timer timer) {
		...
		if (timer==null) {
			...
			if (d==null) return;
			inventory.setItem(13, giveEnergy(location, is, 0.1D));
		} else {
			if (timer.hasExpired()) {
    ...
    public String getDefaultDisplayName() {
        return "§6Basic Charger";
    }

    @Override
    public String getUUID() {
        return "Machine:Charger_Basic"; // 6bcc41e5-5a09-4955-8756-f06c26d61c4d
    }
