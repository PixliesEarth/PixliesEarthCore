...
public class ManualGenerator extends CustomRecipe {
	/**
	...
	public String getResultUUID() {
		return "Machine:Manual_Generator";
	}
	/**
	...
	public Map<Integer, String> getContentsList() {
		...
		map.put(0, "Minecraft:redstone");
		map.put(1, "Minecraft:lever");
		map.put(2, "Minecraft:redstone");
		map.put(3, "Minecraft:lever");
		map.put(4, "Pixlies:Machine_Base_Energy");
		map.put(5, "Minecraft:lever");
		map.put(6, "Minecraft:redstone");
		map.put(7, "Minecraft:lever");
		map.put(8, "Minecraft:redstone");
		return map;
	}
	/**
