...
public class CableAdvanced extends CustomRecipe {
	...
	public Map<Integer, String> getContentsList() {
		...
		map.put(0, "Machine:Cable_Intermediate");
		map.put(1, "Machine:Cable_Intermediate");
		map.put(2, "Machine:Cable_Intermediate");
		map.put(3, "Machine:Cable_Intermediate");
		map.put(4, "Pixlies:Capacitor_Advanced");
		map.put(5, "Machine:Cable_Intermediate");
		map.put(6, "Machine:Cable_Intermediate");
		map.put(7, "Machine:Cable_Intermediate");
		map.put(8, "Machine:Cable_Intermediate");
		return map;
	}
	/**
