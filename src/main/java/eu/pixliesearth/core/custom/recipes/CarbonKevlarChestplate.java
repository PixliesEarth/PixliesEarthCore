...
public class CarbonKevlarChestplate extends CustomRecipe {
	/**
	...
	public String getResultUUID() {
		return "Pixlies:Carbon_Kevlar_Chestplate";
	}
	/**
	...
	public Map<Integer, String> getContentsList() {
		...
		map.put(1, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(2, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(3, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(4, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(5, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(6, "Pixlies:Carbon_Kevlar_Ingot");
		map.put(7, "Pixlies:Carbon_Kevlar_Ingot");
		return map;
	}
	/**
