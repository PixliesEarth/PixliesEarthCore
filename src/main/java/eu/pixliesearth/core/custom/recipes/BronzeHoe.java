...
public class BronzeHoe extends CustomRecipe {
	/**
	 ...
	 */
	@Override
	public String craftedInUUID() { return "Pixlies:Crafting_Table"; }
	/**
	 ...
	 */
	@Override
	public String getResultUUID() { return "Pixlies:Bronze_Hoe"; }
	/**
	 * How many of the result to give
	 */
	@Override
	public int getResultAmount() { return 1; }
	/**
	 * The era required to craft the item
	 */
	@Override
	public Era getEraNeeded() { return Era.TRIBAL; }
	/**
