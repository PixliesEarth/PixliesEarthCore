...
public class OilCanister extends CustomRecipe {
	/**
	...
	public Map<Integer, String> getContentsList() {
		...
		map.put(0, "Pixlies:Oil_Shard");
		map.put(1, "Pixlies:Oil_Shard");
		map.put(2, "Pixlies:Oil_Shard");
		map.put(3, "Pixlies:Oil_Shard");
		map.put(4, "Pixlies:Canister");
		map.put(5, "Pixlies:Oil_Shard");
		map.put(6, "Pixlies:Oil_Shard");
		map.put(7, "Pixlies:Oil_Shard");
		map.put(8, "Pixlies:Oil_Shard");
		return map;
	}
	/**
