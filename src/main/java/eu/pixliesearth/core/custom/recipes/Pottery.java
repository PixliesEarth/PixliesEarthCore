...
public class Pottery extends CustomRecipe {
	/**
	...
	public Map<Integer, String> getContentsList() {
		...
		map.put(1, MinecraftMaterial.BRICK.getUUID());
		map.put(2, MinecraftMaterial.AIR.getUUID());
		map.put(3, MinecraftMaterial.BRICK.getUUID());
		map.put(4, MinecraftMaterial.FLOWER_POT.getUUID());
		map.put(5, MinecraftMaterial.BRICK.getUUID());
		map.put(6, MinecraftMaterial.STONE.getUUID());
		map.put(7, MinecraftMaterial.BRICK.getUUID());
