...
public class TreeTap extends CustomRecipe {

    @Override
    public String getResultUUID() {
        return "Pixlies:TreeTap";
    }
    ...
    public Map<Integer, String> getContentsList() {
        ...
        map.put(0, MinecraftMaterial.STICK.getUUID());
        map.put(1, MinecraftMaterial.WOODEN_HOE.getUUID());
        map.put(2, MinecraftMaterial.AIR.getUUID());
        map.put(3, MinecraftMaterial.AIR.getUUID());
        map.put(4, MinecraftMaterial.STICK.getUUID());
