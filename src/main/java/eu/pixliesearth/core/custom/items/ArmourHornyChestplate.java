 ...
 * @author Zenake
 */
public class ArmourHornyChestplate extends CustomArmour {

    public ArmourHornyChestplate() {
    ...
    public String getUUID() {
        return "Pixlies:Horny_Chestplate"; // 6bcc41e5-5a09-4955-8756-f06c26d61c4d
    }
