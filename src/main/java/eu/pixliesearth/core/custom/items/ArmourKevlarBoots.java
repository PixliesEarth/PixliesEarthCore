 ...
 * @author Zenake
 */
public class ArmourKevlarBoots extends CustomArmour {

    public ArmourKevlarBoots() {
    ...
    public String getUUID() {
        return "Pixlies:Kevlar_Boots"; // 6bcc41e5-5a09-4955-8756-f06c26d61c4d
    }
