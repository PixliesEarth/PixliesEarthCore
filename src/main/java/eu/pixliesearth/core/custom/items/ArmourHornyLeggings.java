 ...
 * @author Zenake
 */
public class ArmourHornyLeggings extends CustomArmour {

    public ArmourHornyLeggings() {
    ...
    public String getUUID() {
        return "Pixlies:Horny_Leggings"; // 6bcc41e5-5a09-4955-8756-f06c26d61c4d
    }
