 ...
 * @author Zenake
 */
public class ArmourKevlarHelmet extends CustomArmour {

    public ArmourKevlarHelmet() {
    ...
    public String getUUID() {
        return "Pixlies:Kevlar_Helmet"; // 6bcc41e5-5a09-4955-8756-f06c26d61c4d
    }
